The HTTPRequest_BSD class simplifys making a HTTP request.
...
So i stopped developing this. 
But i am proud of the code i made and still want to show the knowledge i gained.